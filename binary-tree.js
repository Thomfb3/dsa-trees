...
class BinaryTree {
  ...
  nextLarger(lowerBound) {
    ...
    while (queue.length) {
      ...
      let lessThanClosest = currentVal < closest || closest === null;

      if (largerThanLowerBound && lessThanClosest) {
        closest = currentVal;
      };
  ...
  areCousins(node1, node2) {
    ...
    let differentParent = node1Info && node2Info && node1Info.parent !== node2Info.parent;
